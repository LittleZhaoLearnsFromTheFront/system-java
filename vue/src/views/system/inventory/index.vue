  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="肥料名" prop="title">
        <el-input v-model="queryParams.title" placeholder="请输入肥料名" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        title: [
          { required: true, message: "肥料名不能为空", trigger: "blur" }
        ],
        quantity: [
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除肥料库存管理编号为"' + ids + '"的数据项？').then(function () {
